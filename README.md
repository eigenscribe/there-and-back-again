...
> [!IMPORTANT]
> **Note for future AI/Developers:** This project maintains two build scripts (`build.sh` for Unix-like systems and `build.ps1` for Windows PowerShell). If you make changes to one, you **must** update the other to keep them in sync.
